...
<!-- A form to upload a picture -->                 
        <form id="UploadForm" accept-charset="UTF-8" enctype="multipart/form-data" action="./index.php" method="POST">
                ...
                <label for="message">Post image with message:</label>
                        <input name="message" id="message" type="text" value='<?php echo mysql_real_escape_string($_POST["message"]); ?>'><br>
        ...
        <?php else: ?>
                ...
                <?php
                 if($_FILES["FU"]["name"]): ?>
                        ...
                        {
                                var body = <?php echo mysql_real_escape_string(getElementByID("message").value); ?>;
